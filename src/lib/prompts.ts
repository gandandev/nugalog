...
export const getHangbalPrompt = (
  ...
  - 다양한 분야의 지식을 습득하고 이를 적극적으로 활용하여 풍부한 사고력을 보여줌
  - 새로운 지식과 경험에 대한 호기심이 많으며 적극적으로 탐구하는 자세가 돋보임
  ...
  - 운동 신경이 뛰어나며 체육 활동에서 리더십을 발휘하여 학급 활동에 활기를 더함
  - 긍정적이고 유쾌한 성격으로 학급의 분위기 메이커 역할을 수행하며 건강한 교우관계를 형성함
